 ...
 * oEmbed field class.
 */
class SM_RWMB_OEmbed_Field extends SM_RWMB_URL_Field
{
	/**
	...
	{
		wp_enqueue_style( 'sm-rwmb-oembed', SM_RWMB_CSS_URL . 'oembed.css' );
		wp_enqueue_script( 'sm-rwmb-oembed', SM_RWMB_JS_URL . 'oembed.js', array(), SM_RWMB_VER, true );
	}
	...
	{
		add_action( 'wp_ajax_sm_rwmb_get_embed', array( __CLASS__, 'wp_ajax_get_embed' ) );
	}
