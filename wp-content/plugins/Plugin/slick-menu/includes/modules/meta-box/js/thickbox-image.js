jQuery( function ( $ )
{
	...
	$( 'body' ).on( 'click', '.sm-rwmb-thickbox-upload', function ()
	{
		var $this = $( this ),
			$holder = $this.siblings( '.sm-rwmb-images' ),
			post_id = $( '#post_ID' ).val(),
		...
		window.send_to_editor = function ( html )
		{
			...
			html = '<li id="item_' + id + '">';
			html += '<img src="' + url + '">';
			html += '<div class="sm-rwmb-image-bar">';
			html += '<a class="sm-rwmb-delete-file" href="#" data-attachment_id="' + id + '">×</a>';
			html += '</div>';
