 ...
 *
 */
class SM_Icon_Picker_Type_Image extends SM_Icon_Picker_Type {
	...
	public function __construct( $args = array() ) {
		if ( empty( $this->name ) ) {
			$this->name = __( 'Image', 'slick-menu-icon-picker' );
		}
	...
	public function get_templates() {
		 ...
		 */
		$templates = apply_filters( 'slick_menu_icon_picker_image_media_templates', $templates );
	...
	protected function get_image_mime_types() {
		 ...
		 */
		$mime_types = apply_filters( 'slick_menu_icon_picker_image_mime_types', $mime_types );
