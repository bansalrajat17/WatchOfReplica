...
var IconPickerFontBrowser = wp.media.View.extend( _.extend({
	className: function() {
		var className = 'attachments-browser slick-menu-iconpicker-fonts-browser';
...
IconPickerFontItem = Attachment.extend({
	className: 'attachment slick-menu-iconpicker-item',

	initialize: function() {
		this.template = wp.media.template( 'slick-menu-iconpicker-' + this.options.baseType + '-item' );
...
IconPickerFontLibrary = Attachments.extend({
	className: 'attachments slick-menu-iconpicker-items clearfix',
...
var IconPickerSvgItem = wp.media.view.Attachment.Library.extend({
	template: wp.template( 'slick-menu-iconpicker-svg-item' )
});
...
(function( $ ) {
	...
	updatePreview = function( e ) {
		...
		if ( templates[ type ] ) {
			...
			template = templates[ type ] = wp.template( 'slick-menu-iconpicker-' + iconPicker.types[ type ].templateId + '-icon' );
		}
