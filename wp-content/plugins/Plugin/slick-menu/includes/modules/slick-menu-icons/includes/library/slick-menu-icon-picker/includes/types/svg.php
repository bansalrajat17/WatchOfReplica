 ...
 *
 */
class SM_Icon_Picker_Type_Svg extends SM_Icon_Picker_Type_Image {
	...
	public function __construct( $args = array() ) {
		$this->name = __( 'SVG', 'slick-menu-icon-picker' );
	...
	public function get_templates() {
		$templates = array(
			...
			'item' => sprintf(
				...
				esc_attr__( 'Deselect', 'slick-menu-icons' )
			),
		);
		 ...
		 */
		$templates = apply_filters( 'slick_menu_icon_picker_svg_media_templates', $templates );
