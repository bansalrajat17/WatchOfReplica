...
abstract class SM_Icons_Type {
	...
	function __construct() {
		_deprecated_function( __CLASS__, '0.9.0', 'SM_Icon_Picker_Type' );
	}
	 ...
	 * @uses   apply_filters() Calls 'slick_menu_icons_{type}_props' on type properties.
	 * @return array
	 */
