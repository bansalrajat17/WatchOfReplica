...
if ( !class_exists('Slick_Menu_Update_Checker', false) ):
 ...
 * @access public
 */
class Slick_Menu_Update_Checker {
	...
	public function __construct($metadataUrl, $pluginFile, $slug = '', $checkPeriod = 12, $optionName = '', $muPluginFile = ''){
		...
		$this->upgraderStatus = new Slick_Menu_Upgrader_Status();
	 ...
	 * @return Slick_Menu_Update_Scheduler
	 */
	protected function createScheduler($checkPeriod) {
		return new Slick_Menu_Update_Scheduler($this, $checkPeriod);
	}
	...
	public function requestInfo($queryArgs = array()){
		...
		if ( !is_wp_error($status) ){
			$pluginInfo = Slick_Menu_Plugin_Info::fromJson($result['body']);
			if ( $pluginInfo !== null ) {
	 ...
	 *
	 * @return Slick_Menu_Plugin_Update An instance of PluginUpdate, or NULL when no updates are available.
	 */
	public function requestUpdate(){
		...
		$update = Slick_Menu_Plugin_Update::fromPluginInfo($pluginInfo);
	 ...
	 *
	 * @return Slick_Menu_Plugin_Update|null
	 */
	...
	public function getUpdateState() {
		...
		if ( isset($state, $state->update) && is_object($state->update) ) {
			$state->update = Slick_Menu_Plugin_Update::fromObject($state->update);
		}
		return $state;
	}
	...
	private function setUpdateState($state) {
		if ( isset($state->update) && is_object($state->update) && method_exists($state->update, 'toStdClass') ) {
			$update = $state->update; /** @var Slick_Menu_Plugin_Update $update */
	 ...
	 * @param Slick_Menu_Plugin_Update $updateToAdd
	 * @return StdClass
	 */
...
if ( !class_exists('Slick_Menu_Plugin_Info', false) ):
...
class Slick_Menu_Plugin_Info {
	 ...
	 * @return Slick_Menu_Plugin_Info|null New instance of PluginInfo, or NULL on error.
	 */
...
if ( !class_exists('Slick_Menu_Plugin_Update', false) ):
 ...
 * @access public
 */
class Slick_Menu_Plugin_Update {
	public $id = 0;
	public $slug;
	public $version;
	public $homepage;
	...
	public static function fromJson($json){
		...
		$pluginInfo = Slick_Menu_Plugin_Info::fromJson($json);
		if ( $pluginInfo != null ) {
	 ...
	 * 
	 * @param Slick_Menu_Plugin_Info $info
	 * @return Slick_Menu_Plugin_Update
	 */
	 ...
	 * another object.
	 *  
	 * @param StdClass|Slick_Menu_Plugin_Info|Slick_Menu_Plugin_Update $object The source object.
	 * @return Slick_Menu_Plugin_Update The new copy.
	 */
...
if ( !class_exists('Slick_Menu_Update_Scheduler', false) ):
 ...
 * @version 3.0
 */
class Slick_Menu_Update_Scheduler {
	public $checkPeriod = 12; //How often to check for updates (in hours).
	public $throttleRedundantChecks = false; //Check less often if we already know that an update is available.
	public $throttledCheckPeriod = 72;

	/**
	 * @var Slick_Menu_Update_Checker
	 */
	 ...
	 *
	 * @param Slick_Menu_Update_Checker $updateChecker
...
if ( !class_exists('Slick_Menu_Upgrader_Status', false) ):
 ...
 */
class Slick_Menu_Upgrader_Status {
...
if ( !class_exists('Slick_Menu_Update_Factory', false) ):
 ...
 * versions by calling {@link Slick_Menu_Update_Factory::addVersion()}.
 *
 ...
 * want to instantiate one of them anyway, you can use {@link Slick_Menu_Update_Factory::getLatestClassVersion()}
 * to get the class name and then create it with <code>new $class(...)</code>.
 */
class Slick_Menu_Update_Factory {
	 ...
	 * @return Slick_Menu_Update_Checker
	 */
...
Slick_Menu_Update_Factory::addVersion('PluginUpdateChecker', 'Slick_Menu_Update_Checker', '3.1');
Slick_Menu_Update_Factory::addVersion('PluginUpdate', 'Slick_Menu_Plugin_Update', '3.1');
Slick_Menu_Update_Factory::addVersion('PluginInfo', 'Slick_Menu_Plugin_Info', '3.1');
