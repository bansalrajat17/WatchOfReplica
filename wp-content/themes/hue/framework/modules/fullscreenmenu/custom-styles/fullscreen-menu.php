	...
	function hue_mikado_fullscreen_menu_icon_styles() {
		...
		if(hue_mikado_options()->getOptionValue('fullscreen_menu_icon_color') !== '') {
			...
			echo hue_mikado_dynamic_css('.mkd-fullscreen-menu-opener', array(
				'color' => hue_mikado_options()->getOptionValue('fullscreen_menu_icon_color')
			));
		...
		if(hue_mikado_options()->getOptionValue('fullscreen_menu_icon_hover_color') !== '') {
			...
			echo hue_mikado_dynamic_css('.mkd-fullscreen-menu-opener:hover', array(
				'color' => hue_mikado_options()->getOptionValue('fullscreen_menu_icon_hover_color')
			));

		}

		if(hue_mikado_options()->getOptionValue('fullscreen_menu_light_icon_color') !== '') {
			echo hue_mikado_dynamic_css('.mkd-light-header .mkd-page-header > div:not(.mkd-sticky-header) .mkd-fullscreen-menu-opener:not(.opened),
			...
			.mkd-light-header .mkd-top-bar .mkd-fullscreen-menu-opener:not(.opened)', array(
				'color' => hue_mikado_options()->getOptionValue('fullscreen_menu_light_icon_color').' !important'
			));
		...
		if(hue_mikado_options()->getOptionValue('fullscreen_menu_light_icon_hover_color') !== '') {
			...
			echo hue_mikado_dynamic_css('.mkd-light-header .mkd-page-header > div:not(.mkd-sticky-header) .mkd-fullscreen-menu-opener:not(.opened):hover,
			...
			.mkd-light-header .mkd-top-bar .mkd-fullscreen-menu-opener:not(.opened):hover', array(
				'color' => hue_mikado_options()->getOptionValue('fullscreen_menu_light_icon_hover_color').' !important'
			));
		...
		if(hue_mikado_options()->getOptionValue('fullscreen_menu_dark_icon_color') !== '') {
			...
			echo hue_mikado_dynamic_css('.mkd-dark-header .mkd-page-header > div:not(.mkd-sticky-header) .mkd-fullscreen-menu-opener:not(.opened),
			...
			.mkd-dark-header .mkd-top-bar .mkd-fullscreen-menu-opener:not(.opened)', array(
				'color' => hue_mikado_options()->getOptionValue('fullscreen_menu_dark_icon_color').' !important'
			));
		...
		if(hue_mikado_options()->getOptionValue('fullscreen_menu_dark_icon_hover_color') !== '') {
			...
			echo hue_mikado_dynamic_css('.mkd-dark-header .mkd-page-header > div:not(.mkd-sticky-header) .mkd-fullscreen-menu-opener:not(.opened):hover ,
			...
			.mkd-dark-header .mkd-top-bar .mkd-fullscreen-menu-opener:not(.opened):hover', array(
				'color' => hue_mikado_options()->getOptionValue('fullscreen_menu_dark_icon_hover_color').' !important'
			));
